...
namespace  MapSelectPage
{
	...
	{
		this->img = DG::Image::Create("./data/image/MapMaker/Page.png");
		return true;
	}
	//-------------------------------------------------------------------
	//リソースの解放
	...
	{
		selectingFlag = false;
		if (ge->qa_MapSelect->page == this->orderNum) {
			selectingFlag = true;
		}
	}
	//-------------------------------------------------------------------
	...
	void  Object::Render2D_AF()
	{
		...
		if (true == this->haveDataFlag) {
			src.x = this->imgSizeW;
			this->res->img->Draw(draw, src);
		}
		if (true == this->selectingFlag) {
